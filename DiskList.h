...
#define DELETED_HEAD_OFFSET 4
#define SIZE_OFFSET 8

using namespace std;

struct DiskNode{
    DiskNode() : value(0), next(0) {};
    DiskNode(char v, BinaryFile::Offset n) : value(v), next(n) {};
    char value;
    BinaryFile::Offset next; // 'pointer'
    BinaryFile::Offset offset; // this location
};
...
public:
    ...
    // going to create a linked list of deleted items
    BinaryFile::Offset deleted_head;
